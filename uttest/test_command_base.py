...
class TestCommandBase(AbstractTestCase):
    ...
    def test_init(self, mock_getcwd):
        ...
        # assert
        assert file_support.real_is_local_exist(constant_instance.get_virtual_file_git_folder_path())
        assert file_support.real_is_local_exist(constant_instance.get_virtual_trash_folder_path())
        assert file_support.real_is_local_exist(constant_instance.get_virtual_action_folder_path())
        assert file_support.real_is_local_exist(constant_instance.get_virtual_queue_file_path())
        assert file_support.real_is_local_exist(constant_instance.get_virtual_config_file_path())
        ...
        assert config_instance.get_virtual_local_path() == test_support.fgit_local_virtual_path
        assert config_instance.get_virtual_remote_path() == test_support.fgit_remote_virtual_path
