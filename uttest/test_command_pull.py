...
class TestCommandPush(AbstractTestCase):
    ...
    def test_command_pull_original(self, mock_getcwd):
        ...
        test_support.create_image(1, test_support.test_file_png_1_local_virtual_path)
        test_support.create_image(1, test_support.test_file_png_2_local_virtual_path)
        test_support.create_image(1, test_support.test_file_png_3_local_virtual_path)
