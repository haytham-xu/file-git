...
class TestCommandPush(AbstractBDWPTestCase):
    ...
    def test_command_clone_original(self, mock_getcwd):
        ...
        Hooks.base_hook()
        Hooks.clean_trash()
        test_support.run_command_clone(test_support.TestSupport.original_fgit_mode)
        ...
        assert test_support.count_lines_in_file(success_log_file_path) == 3
    ...
    def test_command_clone_encrypted(self, mock_getcwd):
        ...
        Hooks.base_hook()
        Hooks.clean_trash()
        test_support.run_command_clone(test_support.TestSupport.encrypted_fgit_mode)
