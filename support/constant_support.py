...
class Constant():
    ...
    def __init__(self, local_path="", file_git_foler_name=".fgit", trash_folder_name="trash", action_folder_name="action", queue_file_name="queue.json", config_file_name="config.json"):
    ...
    def set_file_git_folder_name(self, file_git_foler_name):
        self.file_git_foler_name = file_git_foler
    def get_trash_folder_name(self):
        return self.trash_folder_name
    def set_trash_folder_name(self, trash_folder_name):
        self.trash_folder_name = trash_folder_name
    def get_action_folder_name(self):
        return self.action_folder_name
    def set_action_folder_name(self, action_folder_name):
        self.action_folder_name = action_folder_name
    def get_queue_file_name(self):
        return self.queue_file_name
    def set_queue_file_name(self, queue_file_name):
        self.queue_file_name = queue_file_name
